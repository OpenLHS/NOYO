 ...
 * [NOYO.yml](NOYO.yml)
     * Determines how your purl.obolibrary.org/obo/NOYO/ redirects will be handled
     ...
     * Paste in the contents of [NOYO.yml](NOYO.yml)
 ...
 * [NOYO.md](NOYO.md)
     ...
     * Paste in the contents of [NOYO.md](NOYO.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
